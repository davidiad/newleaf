...
public class ColorJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    private void Start()
    {
        ...
        if (GetComponent<Image>() != null && transform.GetChild(0).GetComponent<Image>() !=null)
        {
            ...
            //bgImage.rectTransform.pivot = new Vector2(0.5f, 0.5f); // DF: places the center of background image of this joystick onto the pivot (wherever it may be in the canvas) 
